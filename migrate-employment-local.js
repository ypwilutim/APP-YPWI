...
async function migrate() {
  try {
    ...
    await db.runMultiple(`INSERT IGNORE INTO employment_rules (job_title_pattern, employment_type, min_years, max_years) VALUES ('Admin','PTTY',0,2),('TU','PTTY',0,2),('Operator','PTTY',0,2),('Pimpinan','PTTY',0,2),('Kepala Sekolah','GTY',2,100),('Bendahara','PTTY',0,2),('Guru Mapel','GTY',2,100),('Walikelas','GTY',2,100)`);
